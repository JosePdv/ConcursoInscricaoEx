...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light fundo shadow-sm">
        <div class="container">
            <a class="navbar-brand btn btn-outline-dark" href="{{ url('/site/lista') }}">
                voltar
            </a>
...
<script type="text/javascript">
    ...
    //Validar se todos dos documentos estao corretos para poder serguir o progresso
    function validarDoc(id) {
        if (id == 1) {
            ...
            document.getElementById('anexoForm').style.display = 'bl';
