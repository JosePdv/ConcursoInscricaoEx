        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="#" method="post" id="formAction">
                    ...
                    <div class="row justify-content-center" style="margin-top: 2%; display: none;" id="recursoEnviar">
                        <input type="submit" id='btnEnviar' value="Enviar Recurso" class="btn btn-success">
                    </div>
                </form>
            </div>
                    ...
                    <div class="card-body ">
                        ...
                        @if ($recurso->formularios->escolaridade == 3)
                            <div class="row justify-content-center">
                                <div class="col col-md-6">
                                    <input type="submit" value="Aceitar Recurso" id="btnAprovar"
                                           onclick="validarFormRecurso(4, 3)"
                                           class="btn btn-outline-success">
                                </div>
                                <div class="col col-md-6">
                                    <input type="submit" value="Negar Recurso" id="btnAprovar"
                                           onclick="validarFormRecurso(5, 3)"
                        ...
                        @else
                            <div class="row justify-content-center">
                                <div class="col col-md-6">
                                    <input type="submit" value="Aceitar Recurso" id="btnAprovar"
                                           onclick="validarFormRecurso(4, 0)"
                                           class="btn btn-outline-success">
                                </div>
                                <div class="col col-md-6">
                                    <input type="submit" value="Negar Recurso" id="btnAprovar"
                                           onclick="validarFormRecurso(5, 0)"
                                           class="btn btn-outline-danger">
                                </div>
                            </div>
                        @endif
